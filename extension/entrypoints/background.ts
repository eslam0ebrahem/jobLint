...
const packets = new ApplicationPacketService(jobs, settings);
const analytics = new OutcomeAnalyticsService(jobRepository);
...
}, undefined, undefined, followUpRepository);
